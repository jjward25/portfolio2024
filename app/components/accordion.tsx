...
function Accordion({ title, children }) {
  ...
  return (
    <div className="border border-neutral-400 rounded-lg mb-2 w-full bg-grad">
      <div className={`bg-black hover:bg-gradient-to-r from-black to-neutral-500 border-b-neutral-400 border-b-2 hover:border-white cursor-pointer flex items-center justify-between rounded-lg  p-2 text-sm leading-4 h-9 ${isOpen ? 'bg-gradient-to-r from-black to-neutral-500' : ''}`} onClick={toggleAccordion}>
