...
export function Navbar() {
  ...
  return (
    <aside className="md:mb-16 tracking-tight">
      ...
      <div className={`absolute flex top-0 left-0 w-full max-w-full overflow-hidden h-full bg-gradient-to-tr from-neutral-200 via-white to-neutral-200 ${isMenuOpen? 'z-50 opacity-98 transition-all ease-in':'-z-50 opacity-0 transition-all ease-in'}`}>
        <div className="w-auto max-w-full overflow-hidden h-full m-auto my-auto flex flex-col">
