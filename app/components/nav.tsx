...
export function Navbar() {
  ...
  return (
    <aside className="md:mb-16 tracking-tight">
      ...
      <div className={`fixed flex top-0 left-0 w-full max-w-full overflow-hidden h-full bg-gradient-to-tr from-neutral-200 via-white to-neutral-200 ${isMenuOpen? 'z-50 opacity-98 transition-all ease-in':'-z-50 opacity-0 transition-all ease-in'}`}>
