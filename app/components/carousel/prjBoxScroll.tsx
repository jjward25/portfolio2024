...
const PrjBoxScroll: React.FC<CardProps> = ({ title, description, imageUrls, skills, link }) => {
  ...
  return (
    <div className="relative w-full min-w-[310px] min-h-[300px] md:min-w-[350px] md:min-h-[250px] h-full overflow-hidden rounded-lg shadow-lg border border-cyan-700">
      ...
      {/** Left Scroll Button */}
      <button
          className="z-10 ml-1 absolute left-0 top-1/2 transform -translate-y-1/2 bg-cyan-950 text-cyan-700 p-1 rounded-full hover:text-yellow-200 transition border border-cyan-700"
      ...
      {/** Right Scroll Button */}
      <button
          className="z-10 mr-1 absolute right-0 top-1/2 transform -translate-y-1/2 bg-cyan-950 text-cyan-700 p-1 rounded-full hover:text-yellow-200 transition border border-cyan-700"
