import PrjBox from "../components/carousel/prjBox";
        ...
        <div className="flex flex-col bg-black md:rounded-xl -mx-10 p-4 pt-6 pb-3 w-2/1">
            ...
            <div className="flex flex-row text-black gap-4 overflow-auto pb-5 mb-1">
                ...
                <PrjBoxScroll
                    ...
                    imageUrls= {['/projects/scrapers/runAll.png','/projects/scrapers/scraperSelenium.png','/projects/scrapers/scraperBeautifulSoup.png','/projects/scrapers/scraperOutput.png']}
                    skills={[
                      { url: '/skill/python.png', title: 'Python: Beautiful Soup, Selenium, Pandas' },
                      ]}
