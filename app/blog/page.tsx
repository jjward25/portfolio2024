...
export default function BlogPage() {
  return (
    <section>
      ...
      <DynamicAccordion title="Other Content" isOpenByDefault={true}>
      <li><Link target="_blank" href="/blog/articles/nbamvp" className="cursor-pointer hover:text-yellow-600 text-sm md:text-md">Predicting the NBA MVP with Public Datasets</Link></li>
