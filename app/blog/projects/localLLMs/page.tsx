  ...
  return (
    <section>
      ...
      <article className="prose prose-quoteless prose-neutral dark:prose-invert w-full h-full flex flex-col text-black">
        ...
        <p className="text-neutral-500 text-sm mt-4 mb-0">{`This style of script can work with any model downloaded from Ollama as long as your computer can run it.  In the video below I am running these on an HP laptop with no GPU.`}</p>
